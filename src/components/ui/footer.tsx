        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><a href="/servicios" className="text-base text-gray-400 hover:text-white">Servicios</a></li>
              <li><a href="/diseno-grafico" className="text-base text-gray-400 hover:text-white">Diseño Gráfico</a></li>
              <li><a href="/cursos" className="text-base text-gray-400 hover:text-white">Cursos</a></li>
              <li><a href="/portafolio" className="text-base text-gray-400 hover:text-white">Portafolio</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><a href="/aviso-de-privacidad" className="text-base text-gray-400 hover:text-white">Aviso de Privacidad</a></li>
              <li><a href="/terminos-y-condiciones" className="text-base text-gray-400 hover:text-white">Términos y Condiciones</a></li>
            </ul>
          </div>
